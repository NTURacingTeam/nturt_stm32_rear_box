...
unsigned char CRC8_Calc(unsigned char*, const unsigned char);
void MLX90614_WriteReg(unsigned char, unsigned char, unsigned short);
unsigned short MLX90614_ReadReg(unsigned char, unsigned char, unsigned char);
float MLX90614_ReadTemp(unsigned char, unsigned char);
void MLX90614_ScanDevices (void);
void MLX90614_SendDebugMsg(unsigned char, unsigned char, unsigned char, unsigned short, unsigned char, unsigned char);
